...
public class PasswordResetActivity extends AppCompatActivity {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(et_old_password.getText().toString())) {
                    ...
                    dialog.setMessage("Veuillez saisir votre adresse email ");
    ...
    private void resetPassword(String adresse_email) {
        // Create login request
        PasswordResetRequest passwordResetRequest = new PasswordResetRequest(adresse_email);

        // Call the login API
        loginService.resetPassword(passwordResetRequest).enqueue(new Callback<PasswordResetApiResponse>() {
            @Override
            public void onResponse(Call<PasswordResetApiResponse> call, Response<PasswordResetApiResponse> response) {
            ...
            @Override
            public void onFailure(Call<PasswordResetApiResponse> call, Throwable t) {
